        ...
        private async Task GetDiscordWebhookURLFromConfigFile(string discordURLpath)
        {
            try
            {
                ...
                if (jsonConfig != null)
                {
                    ...
                    discordWebhookImageRepoURL = root.TryGetProperty("DiscordWebhookMapImageRepoUrl", out var mapImageRepoUrl) ? mapImageRepoUrl.GetString()! : "https://mirror.ghproxy.com/https://raw.githubusercontent.com/deafps/SharpTimerDiscordWebhookMapPics/main/images/";
