...
namespace SharpTimer
{
    public partial class SharpTimer
    {
                ...
                Task.Run(async () =>
                {
                    ...
                    if (srEnabled == true)
                    {
                        ...
                        if (sortedRecords.Count == 0)
                        {
                            ...
                            topReplayFrames = maxReplayFrames;
                            return;
                        }
        ...
        public double CalculatePoints(int timerTicks)
        {
            ...
            if((double)topReplayFrames / timerTicks < 1)
                points = Math.Round(basePoints * ((double)topReplayFrames / timerTicks ));
            return points;
        }
